...
public class FlatController {
    ...
    public ResponseEntity<List<FlatDTO>> getFlatsByBuildingId(
        ...
        // Check if the first flat belongs to the user's society
        if (!flats.isEmpty()) {
            FlatDTO firstFlat = flats.get(0);
            if (currentUser.getSociety() != null && 
                !currentUser.getSociety().getId().equals(firstFlat.getBuildingId()) && 
    ...
    public ResponseEntity<FlatDTO> createFlat(
        ...
        // Additional validation can be added here to ensure the building belongs to the admin's society
    ...
    public ResponseEntity<FlatDTO> updateFlat(
        ...
        // Additional validation can be added here to ensure the flat belongs to the admin's society
